...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MaiaCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strMainNetOnionSeed[][1] = {
    {"yb7khzpwak2kexr7.onion"}, // node 02 hybrid
    {"kp2cn6ndfbsil6iz.onion"}, // node 03 hybrid
    {"mrp77r53iwbmlkgb.onion"}, // node 04 native
    {"vjfinlo3xqlqv67h.onion"}, // node 05 native
    {NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MaiaCoin is probably already running."), addrBind.ToString().c_str());
        else
