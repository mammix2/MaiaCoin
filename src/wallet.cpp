...
// maiacoin: total coins staked (non-spendable until maturity)
...
// maiacoin: check 'spent' consistency between wallet and txindex
// maiacoin: fix wallet spent state according to txindex
...
// maiacoin: disable transaction (only for coinstake)
