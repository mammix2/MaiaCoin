...
{
    if (pindexBest->nHeight > (fTestNet ? 100 : 686000)) {
        nTargetSpacing = 5 * 60;
	}
...
bool CBlock::AcceptBlock()
{
    ...
    if (IsProofOfWork()){
        if (GetBoolArg("-testnet")){
            ...
            else if (nHeight > P2_End_TestNet && nHeight < P3_Start_TestNet){
                return DoS(100, error("AcceptBlock() : reject proof-of-work at height %d", nHeight));
            }
            else if (nHeight > P3_End_TestNet){
                return DoS(100, error("AcceptBlock() : reject proof-of-work at height %d", nHeight));
            }
        }else{
            ...
            else if (nHeight > P2_End && nHeight < P3_Start){
                return DoS(100, error("AcceptBlock() : reject proof-of-work at height %d", nHeight));
            }
            else if (nHeight > P3_End){
                return DoS(100, error("AcceptBlock() : reject proof-of-work at height %d", nHeight));
            }
